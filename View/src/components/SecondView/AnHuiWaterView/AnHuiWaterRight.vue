...
onMounted(() => {
    ...
    loadBMap("EGlnrCfbkZCDlamN0ap6OPQpuQhUsdmt").then(() => {
        const data = [
            {name: '合肥', value: 200, thing: '一号水电厂'},
            {name: '马鞍山', value: 100, thing: '二号水电厂'},
        ];
        const geoCoordMap = {
            海门: [121.15, 31.89],
            ...
            series: [
                {
                    ...
                    symbol: 'image://' + require('../../../assets/waterdian.png'),
                    symbolSize: 50,
                    emphasis: {
                        label: {
                            show: true
...
<template>
  <div class="AnHuiWaterRight">
      <div class="title">安徽省水利发电基地分布</div>
      <img src="../../../assets/pic/border3.png" alt="" class="BackImg">
      <div class="ecahrts">
          <div class="AnHuiWaterRight-echarts" ref="echartsRef"></div>
      </div>
  </div>
</template>
