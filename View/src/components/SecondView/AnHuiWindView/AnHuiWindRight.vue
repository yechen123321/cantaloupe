...
onMounted(() => {
    ...
    myChart61.on('click', function (params) {
    ...
    loadBMap("EGlnrCfbkZCDlamN0ap6OPQpuQhUsdmt").then(() => {
            ...
            series: [
                {
                    ...
                    symbol: 'image://' + require('../../../assets/1.png'), // 使用 require 加载图片
        ...
        option61 && myChart61.setOption(option61);
    });
