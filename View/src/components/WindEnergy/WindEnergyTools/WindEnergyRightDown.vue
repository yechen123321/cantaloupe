...
onMounted(() => {
    ...
    const data = (function () {
        ...
        let len = 10;
        while (len--) {
            res.push(Number(getRandomNumber(10, 25).toFixed(1)));
        }
        return res;
    })();
    ...
    setInterval(function () {
        ...
        data.shift();
        data.push(Number(getRandomNumber(10, 25).toFixed(1)));
        data2.shift();
