...
onMounted(() => {
    ...
    const data = (function () {
        ...
        let len = 10;
        while (len--) {
            res.push(Number(getRandomNumber(10, 60).toFixed(1)));
        }
        return res;
    })();
